          ...
          <form className="form-stack">
            <div>
              ...
              <div className="input-wrapper">
                ...
                <input className="input" placeholder={t('login.email')} required type="text" />
              </div>
            </div>
            <div>
              ...
              <div className="input-wrapper">
                ...
                <input className="input" placeholder={t('login.password')} required type="password" />
            ...
            <button type="submit" className="btn-primary">{t('login.button')}</button>
          </form>
